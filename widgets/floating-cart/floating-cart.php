...
class Floating_Cart extends Widget_Base {
    ...
    protected function render() {
        ...
        // Translators: 1: Widget title, 2: Link to CoDesigner Pro page.
        echo wcd_notice( sprintf( __( 'This beautiful widget, <strong>%1$s</strong> is a premium widget. Please upgrade to <strong>%2$s</strong> or activate your license if you already have upgraded!', 'codesigner' ), $this->get_title(), '<a href="https://codexpert.io/codesigner" target="_blank">CoDesigner Pro</a>' ) );
