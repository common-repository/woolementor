...
class Ask_For_Price extends Widget_Base {
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'hide_label',
			[
				'label'         => __( 'Hide Label', 'codesigner' ),
		...
		$this->add_control(
			'input_field_set',
			[
				'label' => __( 'Form Fields', 'codesigner' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'input_label' 	=> __( 'First Name', 'codesigner' ),
					...
					[
						'input_label' 	=> __( 'Last Name', 'codesigner' ),
					...
					[
						'input_label' 	=> __( 'Email', 'codesigner' ),
						// 'input_class' 	=> 'form-row-last',
						'input_type' 	=> 'email',
						'input_name' 	=> 'email',
		...
		$this->add_control(
			...
			[
				...
				// Translators: 1: Placeholder for a field name in the form data, 2: Placeholder for a field name in the form data.
				'raw'	=> sprintf( __( 'You can use any data from submitted form. use %1$s where you want to use submitted form data. %2$s will be replaced with actual form data', 'codesigner' ), "<code>%%your_field_name%%</code>", "<code>%%your_field_name%%</code>" ),
		...
		$this->add_control(
			'admin_mail_subject',
			[
				'label'         => __( 'Admin Mail Subject', 'codesigner' ),
				'type'          => Controls_Manager::TEXT,
				'label_block'	=> true,
				'default'		=> __( 'New response mail', 'codesigner' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'         => __( 'Enable auto response mail', 'codesigner' ),
				'type'          => Controls_Manager::SWITCHER,
				'label_on'      => __( 'yes', 'codesigner' ),
				'label_off'     => __( 'no', 'codesigner' ),
				'return_value'  => 'yes',
		...
		$this->add_control(
			'customer_email_name',
			[
				'label'         => __( 'Customer Email Field name', 'codesigner' ),
				'type'          => Controls_Manager::TEXT,
				'default'       => 'email',
				'label_block'	=> true,
				'condition' 	=> [
		...
		$this->add_control(
			'email_subject',
			[
				'label'         => __( 'Email Subject', 'codesigner' ),
				'type'          => Controls_Manager::TEXT,
				'label_block'	=> true,
				'default'		=> __( 'Email Subject', 'codesigner' ),
				'description'	=> __( 'Thank you! We reach you soon', 'codesigner' ),
				'condition' 	=> [
					'enable_response_mail' 	=> 'yes',
				]
			]
		...
		$this->add_control(
			'email_body',
			[
				'label'         => __( 'Email Body', 'codesigner' ),
				'type'          => Controls_Manager::WYSIWYG,
				'label_block'	=> true,
				'default'		=> __( 'Thank you! We reach you soon', 'codesigner' ),
				'condition' 	=> [
					'enable_response_mail' 	=> 'yes',
				]
			]
		...
		$this->add_control(
			...
			[
				'label'         => __( 'On site action after submission', 'codesigner' ),
		...
		$this->add_control(
			...
			[
				'label'         => __( 'Response Type', 'codesigner' ),
				'type'          => Controls_Manager::SELECT,
				'label_block'	=> true,
				'options'		=> [
					'message' 	=> __( 'Message', 'codesigner' ),
					'redirect' 	=> __( 'Redirect', 'codesigner' ),
					'both' 		=> __( 'Both', 'codesigner' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'         => __( 'Response Message', 'codesigner' ),
				'type'          => Controls_Manager::WYSIWYG,
				'label_block'	=> true,
				'default'		=> __( 'Thank you! We reach you soon', 'codesigner' ),
				'conditions' 	=> [
		...
		$this->add_control(
			...
			[
				'label' 	=> __( 'Gap Between Inputs', 'codesigner' ),
		...
		$this->add_control(
			...
			[
				'label' 	=> __( 'Gap Between Options', 'codesigner' ),
				'type' 		=> Controls_Manager::SLIDER,
				'size_units'=> [ 'px' ],
				'range' 	=> [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label' 	=> __( 'Label Styling', 'codesigner' ),
				'type' 		=> Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' 	=> __( 'Options Styling', 'codesigner' ),
				'type' 		=> Controls_Manager::HEADING,
				'separator'		=> 'before',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Option Typography', 'codesigner' ),
				'global' 	=> [
					'default' => Global_Typography::TYPOGRAPHY_PRIMARY,
				],
		...
		$this->add_control(
			...
			[
				'label' 	=> __( 'Input Width', 'codesigner' ),
				'type' 		=> Controls_Manager::SLIDER,
				'size_units'=> [ 'px', '%' ],
				'range' 	=> [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label' 	=> __( 'Button Width', 'codesigner' ),
				'type' 		=> Controls_Manager::SLIDER,
				'size_units'=> [ 'px', '%' ],
				'range' 	=> [
					'px' => [
