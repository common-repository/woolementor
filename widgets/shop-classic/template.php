                        ...
                        <div class="wl-sc-product-details">
                            ...
                            <div class="wl-sc-info-icons">
                                ...
                                if ( 'yes' == $wishlist_show_hide ): ?>
                                    <div class="wl-sc-product-fav ajax_add_to_wish <?php echo esc_attr( $fav_item ); ?>" data-product_id="<?php echo esc_attr( $product_id ); ?>">
                                ...
                                if ( 'yes' == $cart_show_hide ): ?>
                                    <?php if ( 'simple' == $product->get_type() ): ?>
                                        <div class="wl-cart-area">
                                            <a href="?add-to-cart=<?php echo esc_attr( $product_id ); ?>" data-quantity="1" class="wl-sc-product-cart button product_type_<?php echo esc_attr( $product->get_type() ); ?> add_to_cart_button ajax_add_to_cart" data-product_id="<?php echo esc_attr( $product_id ); ?>" ><i class="<?php echo esc_attr( $cart_icon['value'] ); ?>"></i></a>
                                        </div>
                                    <?php else: ?>
                                        <div class="wl-cart-area">
                                            <a href="<?php echo esc_url( get_permalink( $product_id ) ); ?>" data-quantity="1" class="wl-sc-product-cart button product_type_<?php echo esc_attr( $product->get_type() ); ?>" data-product_id="<?php echo esc_attr( $product_id ); ?>"><i class="<?php echo esc_attr( $cart_icon['value'] ); ?>"></i></a>
                                        </div>
                                    <?php endif;
                                endif; 
